Public Class Frm_categorias
    ...
    Dim objnego As New N_Categoria

#Region "Funciones y procedimientos "
    Public Sub grabar()
        objenti.descat = TxtDescripcion.Text.Trim

        Dim fac As String = objnego.n_Registrar(objenti)

        MsgBox("Se grabo exitosamente el nueva categoria con el codigo: " + fac + " !!!", 32, "mensaje del sistema")
    End Sub

    Public Sub actualizar()
        objenti.codcat = Txtcodigo.Text.Trim
        objenti.descat = TxtDescripcion.Text.Trim

        Dim fac As String = objnego.n_actualizar(objenti)

        MsgBox("Se Actualizo exitosamente la categoria con el codigo: " + fac + " !!!", 32, "mensaje del sistema")
    End Sub

    Public Sub eliminar()
        objenti.codcat = Txtcodigo.Text.Trim
        Dim fac As String = objnego.N_eliminar_cat(objenti)
    ...
    Public Sub cargar_cat()
        objenti.criterio = TxtBuscategoria.Text.Trim
        Dim Tabla As DataTable = objnego.N_listar_cat(objenti)
        DGVCategoria.DataSource = Tabla
    End Sub

    Public Sub RecuperarDatosGrilla()
        With DGVCategoria.CurrentRow
...
#End Region
    ...
    Private Sub btn_salir_Click(sender As Object, e As EventArgs) Handles btn_salir.Click
        If MessageBox.Show("Esta seguro de Salir del Mant. De Categorias ",
    ...
    Private Sub TxtBuscategoria_TextChanged(sender As Object, e As EventArgs) Handles TxtBuscategoria.TextChanged
        cargar_cat()
    End Sub
